CREATE TABLE IF NOT EXISTS Customers (
    `CustomerID` VARCHAR(3) CHARACTER SET utf8,
    `CustomerName` VARCHAR(37) CHARACTER SET utf8,
    `ContactName` VARCHAR(21) CHARACTER SET utf8,
    `Address` VARCHAR(47) CHARACTER SET utf8,
...
CREATE TABLE IF NOT EXISTS Categories (
    `CategoryID` VARCHAR(2) CHARACTER SET utf8,
    `CategoryName` VARCHAR(15) CHARACTER SET utf8,
    `Description` VARCHAR(59) CHARACTER SET utf8
);
...
CREATE TABLE IF NOT EXISTS Employees (
    `EmployeeID` VARCHAR(3) CHARACTER SET utf8,
    `LastName` VARCHAR(10) CHARACTER SET utf8,
    `FirstName` VARCHAR(9) CHARACTER SET utf8,
    `BirthDate` DATETIME,
    `Photo` VARCHAR(12) CHARACTER SET utf8,
    `Notes` VARCHAR(421) CHARACTER SET utf8
);
...
CREATE TABLE IF NOT EXISTS OrderDetails (
    `OrderDetailID` VARCHAR(4) CHARACTER SET utf8,
    `OrderID` VARCHAR(6) CHARACTER SET utf8,
    `ProductID` VARCHAR(3) CHARACTER SET utf8,
    `Quantity` VARCHAR(4) CHARACTER SET utf8
);
...
CREATE TABLE IF NOT EXISTS Orders (
    `OrderID` VARCHAR(6) CHARACTER SET utf8,
    `CustomerID` VARCHAR(3) CHARACTER SET utf8,
    `EmployeeID` VARCHAR(2) CHARACTER SET utf8,
    `OrderDate` DATETIME,
    `ShipperID` VARCHAR(2) CHARACTER SET utf8
);
...
CREATE TABLE IF NOT EXISTS Products (
    `ProductID` VARCHAR(3) CHARACTER SET utf8,
    `ProductName` VARCHAR(33) CHARACTER SET utf8,
    `SupplierID` VARCHAR(3) CHARACTER SET utf8,
    `CategoryID` VARCHAR(2) CHARACTER SET utf8,
    `Unit` VARCHAR(21) CHARACTER SET utf8,
    `Price` VARCHAR(7) CHARACTER SET utf8
);
...
CREATE TABLE IF NOT EXISTS Shippers (
    `ShipperID` VARCHAR(2) CHARACTER SET utf8,
    `ShipperName` VARCHAR(17) CHARACTER SET utf8,
...
CREATE TABLE IF NOT EXISTS Suppliers (
    `SupplierID` VARCHAR(3) CHARACTER SET utf8,
    `SupplierName` VARCHAR(39) CHARACTER SET utf8,
    `ContactName` VARCHAR(28) CHARACTER SET utf8,
    `Address` VARCHAR(46) CHARACTER SET utf8,
